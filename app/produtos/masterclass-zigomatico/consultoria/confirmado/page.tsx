...
import { ConfirmacaoHero } from '@/components/masterclass-zigomatico/consultoria/ConfirmacaoHero';
...
export const metadata: Metadata = {
  title: 'Recebemos seus dados — Masterclass Zigomático Descomplicado',
