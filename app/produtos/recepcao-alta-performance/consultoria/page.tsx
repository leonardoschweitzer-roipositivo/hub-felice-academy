...
import { ConsultoriaQuiz } from '@/components/recepcao-alta-performance/consultoria/ConsultoriaQuiz';
...
export const metadata: Metadata = {
  title: 'Agende sua consultoria gratuita — Recepção de Alta Performance',
  description:
