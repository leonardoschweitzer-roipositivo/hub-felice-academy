...
/* Recebe a candidatura à Consultoria e repassa a um webhook configurável
   (LEAD_WEBHOOK_URL — CRM, Zapier, Make, planilha…). Sem webhook
   definido, registra no log do servidor e segue (não bloqueia o fluxo).

   Mesmo handler das outras landings, com UMA diferença: aqui o lead é
   FRIO (veio da landing, não de uma compra), então o CAPI recebe
   leadType 'cold'. */
