...
/* Recebe a candidatura à Mentoria de Zigomático e repassa a um webhook
   configurável (LEAD_WEBHOOK_URL — CRM, Zapier, Make, planilha…). Sem
   webhook definido, registra no log do servidor e segue (não bloqueia o
   fluxo, que continua no WhatsApp).

   Mesmo handler das outras landings; aqui o lead é FRIO (veio da landing,
   não de uma compra), então o CAPI recebe leadType 'cold'. */
