...
/* Escassez: uma hora comigo valeria R$ 500; nesta semana liberei alguns
   horários gratuitos para quem acabou de entrar na Maestria. */
    ...
    <section className="sec obg-prazo-sec">
      <div className="wrap">
        <div className="obg-prazo reveal">
          ...
          <p>
            Como você acabou de entrar na Maestria Zigomática, abri uma quantidade limitada de
            horários gratuitos na minha agenda esta semana para te ajudar a sair das aulas e ir para
            a sala. Quando essas vagas acabarem, a consultoria volta a ser paga — então garanta a sua
            agora.
          </p>
