    ...
    <section className="sec authority">
      <div className="wrap auth-grid">
        ...
        <div className="reveal d1">
          ...
          <blockquote>
            &quot;Na consultoria eu olho para o seu cenário e te mostro exatamente por onde começar a
            operar zigomáticos. O mesmo protocolo que aplico na minha própria sala.&quot;
          </blockquote>
