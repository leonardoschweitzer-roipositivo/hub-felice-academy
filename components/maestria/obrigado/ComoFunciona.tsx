const PASSOS = [
  ...
  },
  {
    ...
    d: 'Você recebe os detalhes da reunião e um espaço para me contar rapidamente sobre os seus casos e a sua experiência.',
  },
  {
    n: '3',
    t: 'Conversamos por 1 hora, online',
    d: 'No horário marcado, eu falo diretamente com você para planejarmos o seu primeiro caso zigomático.',
  },
];
