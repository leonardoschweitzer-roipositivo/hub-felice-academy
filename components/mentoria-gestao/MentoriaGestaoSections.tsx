...
/* ============================================================
   MENTORIA DE GESTÃO F4 · Seções da landing (padrão Felice / dourado)
   Fork estrutural da Maestria Zigomática — mesmas classes de
   felice.css + maestria.css. Copy e dados vêm de ./content.ts.
   ============================================================ */

/* ---------- Hero ----------
   Layout em 2 colunas: à esquerda headline + CTAs; à direita cards
      ...
      <div className="wrap mz-hero">
        ...
        <div className="mz-hero-left">
          ...
          <div className="hero-cta reveal d3">
            ...
            <a href="#recebe" className="btn btn-ghost btn-lg">
...
/* ---------- Números / prova ---------- */
export function MentoriaGestaoNumeros() {
  return (
...
/* ---------- Problema / dores ---------- */
export function MentoriaGestaoProblema() {
  return (
    <section className="sec problem">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Você é dentista — mas passa o dia{' '}
            <span className="gold-grad">apagando incêndio de gestão?</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            A clínica que depende de você para tudo não cresce: ela te prende. Sem processo nos 4
            pilares, cada dia é no improviso.
          </p>
        </div>
        <div className="problem-photo reveal d1">
          <picture>
            ...
            <img
              ...
              alt="Dentista sobrecarregado com a gestão da própria clínica"
              width={1000}
              height={545}
              loading="lazy"
            />
...
/* ---------- Os 4 pilares (método) ---------- */
export function MentoriaGestaoMetodo() {
  return (
    <section className="sec" id="pilares">
      <div className="wrap">
        <div className="sec-head center reveal">
          <span className="eyebrow" style={{ justifyContent: 'center' }}>
            O método F4
...
export function MentoriaGestaoEntregas() {
  return (
    <section className="sec" id="recebe">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Não é um curso. É um <span className="gold-grad">ecossistema de crescimento.</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Plataforma, encontros ao vivo, treinamento da sua equipe e ferramentas prontas — tudo
            para você aplicar os 4 pilares na prática, desde o primeiro dia.
          </p>
        </div>
...
export function MentoriaGestaoTrilhas() {
  return (
    <section className="sec" id="trilhas">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            O que você e a sua equipe <span className="gold-grad">dominam em cada pilar</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Trilhas organizadas na plataforma — cada cargo treina no seu pilar, no mesmo padrão.
          </p>
        </div>
            ...
            <article className={`mz-mod reveal${i ? ` d${i % 4}` : ''}`} key={t.n}>
              <div className="mz-mod-media" aria-hidden="true">
                {t.img ? (
                  ...
                  <span className="mz-mod-media-ph">Pilar {t.n}</span>
                )}
              </div>
              <header className="mz-mod-head">
                <span className="mz-mod-num">Pilar {t.n}</span>
                <h3>{t.titulo}</h3>
                <p>{t.resumo}</p>
              </header>
...
export function MentoriaGestaoBonus() {
      ...
      <div className="wrap">
        ...
        <div className="mz-bonus-total reveal">
          ...
          <p className="mz-bonus-total-note">
            Tudo isto está <b>incluso</b> para quem entra na Mentoria de Gestão F4.
          </p>
        </div>
      </div>
    </section>
...
export function MentoriaGestaoPlataforma() {
  return (
    <section className="sec">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Não é um curso solto. É <span className="gold-grad">uma mentoria organizada.</span>
          </h2>
        </div>
...
/* ---------- Autoridade / mentor ---------- */
export function MentoriaGestaoAutoridade() {
  return (
...
export function MentoriaGestaoOferta() {
  return (
    <section className="sec offer" id="candidatura">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Candidate-se à <span className="gold-grad">Mentoria de Gestão F4</span>
          </h2>
        </div>
...
/* ---------- CTA final ---------- */
export function MentoriaGestaoFinal() {
  return (
