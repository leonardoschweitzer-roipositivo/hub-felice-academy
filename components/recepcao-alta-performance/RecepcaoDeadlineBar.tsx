...
/**
 * Barra de escassez AUTÊNTICA: contagem regressiva até o fechamento real do
 * lote (DEADLINE_ISO). Sem viewers nem toasts falsos.
 *
 ...
 *
 * ⚠️ Com DEADLINE_ISO no passado o relógio congela em 00:00:00:00 e a barra
 * continua no ar — mantenha a data sempre à frente de hoje.
 */
...
export function RecepcaoDeadlineBar() {
    ...
    <div className="urgency-bar" ref={barRef}>
      <div className="wrap urgency-bar-inner">
        <div className="countdown" role="timer" aria-live="off">
          ...
          <span className="countdown-label">A oferta deste lote encerra em</span>
        ...
        <span className="mz-vagas">
          <span className="mz-vagas-dot" /> Condição do lote atual
        </span>
      </div>
    </div>
  );
