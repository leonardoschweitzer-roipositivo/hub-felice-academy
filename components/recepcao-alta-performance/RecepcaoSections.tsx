...
/* ============================================================
   "RECEPÇÃO DE ALTA PERFORMANCE" · Seções da landing (padrão Felice)
   Fork estrutural do CRC de Alta Performance (vendas-secretaria) —
   mesmas classes de felice.css / maestria.css. Copy vem de ./content.ts.
   ============================================================ */

/* ---------- Hero (2 colunas: headline + cards glass de prova) ---------- */
export function RecepcaoHero() {
  return (
    <section className="hero mz-hero-sec" id="topo">
      <div className="hero-bg" />
      <div className="mz-hero-photo rap-hero-photo" aria-hidden="true" />
...
/* ---------- Números / prova ---------- */
export function RecepcaoNumeros() {
  return (
...
/* ---------- Problema / dores ---------- */
export function RecepcaoProblema() {
  return (
    <section className="sec problem">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Sua recepção recebe o paciente — mas{' '}
            <span className="gold-grad">está encantando ele?</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Você investiu em equipamento, em ambiente e em marketing. Só que a primeira coisa que o
            paciente encontra na sua clínica é o balcão — e é ali que ele decide se confia no resto.
          </p>
        </div>
...
export function RecepcaoMetodo() {
  return (
    <section className="sec" id="metodo">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Os <span className="gold-grad">4 pilares</span> que a Disney usa, traduzidos para a sua
            clínica
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Segurança, Cortesia, Show e Eficiência — nessa ordem. Quando dois pilares entram em
            conflito, é ela que diz o que vem primeiro. É o que transforma boa vontade em método.
          </p>
        </div>
...
/* ---------- Módulos ---------- */
export function RecepcaoModulos() {
  return (
    <section className="sec" id="modulos">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            4 módulos, 20 aulas. <span className="gold-grad">Da chegada do paciente ao plano de melhoria contínua.</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Aulas curtas e diretas, cada uma terminando numa atividade prática de recepção — para a
            equipe sair da aula sabendo o que fazer no próximo paciente que entrar.
          </p>
        </div>
      ...
      <div className="wrap">
        ...
        <div className="mz-bonus-total reveal">
          ...
          <p className="mz-bonus-total-note">
            Tudo isto está <b>incluso gratuitamente</b> na sua matrícula do Recepção de Alta
            Performance.
          </p>
        </div>
      </div>
...
export function RecepcaoPlataforma() {
  return (
    <section className="sec">
      <div className="wrap">
        <div className="sec-head center reveal">
          <span className="eyebrow" style={{ justifyContent: 'center' }}>
            Como a equipe estuda
          </span>
          <h2>
            Um treinamento que <span className="gold-grad">fica com a sua clínica.</span>
          </h2>
        </div>
...
/* ---------- Autoridade / mentor ---------- */
export function RecepcaoAutoridade() {
  return (
...
/* ---------- Oferta ---------- */
export function RecepcaoOferta() {
  return (
    <section className="sec offer" id="oferta">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Garanta o acesso ao <span className="gold-grad">Recepção de Alta Performance</span>
          </h2>
        </div>
