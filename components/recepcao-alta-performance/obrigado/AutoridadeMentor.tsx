    ...
    <section className="sec authority">
      <div className="wrap auth-grid">
        ...
        <div className="reveal d1">
          ...
          <blockquote>
            &quot;Na consultoria eu olho para a sua recepção e te mostro exatamente o que mudar
            primeiro. É o mesmo padrão de atendimento que eu exijo na minha própria clínica.&quot;
          </blockquote>
          <div className="auth-name">Dr. Sócrates Tavares</div>
          <p className="auth-role">
            Cirurgião-dentista e diretor-clínico da Felice Odontologia — criador do método F4 de
            gestão de clínicas
          </p>
          <ul className="creds">
            {CREDS.map((c) => (
