const PASSOS = [
  {
    ...
    d: 'São 8 perguntas rápidas sobre a sua clínica e o seu atendimento. Leva menos de dois minutos.',
  },
  {
    n: '2',
  ...
  },
  {
    ...
    d: 'No horário marcado, eu falo diretamente com você para definirmos o que a sua recepção muda primeiro.',
  },
];
