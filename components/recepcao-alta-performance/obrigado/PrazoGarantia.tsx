...
/* Escassez: uma hora comigo valeria R$ 500; nesta semana liberei alguns
   horários gratuitos para quem acabou de matricular a equipe. */
    ...
    <section className="sec obg-prazo-sec">
      <div className="wrap">
        <div className="obg-prazo reveal">
          ...
          <p>
            Como você acabou de matricular a sua equipe na Recepção de Alta Performance, abri uma
            quantidade limitada de horários gratuitos na minha agenda esta semana para te ajudar a
            tirar o método do vídeo e pôr no seu balcão. Quando essas vagas acabarem, a consultoria
            volta a ser paga — então garanta a sua agora.
          </p>
