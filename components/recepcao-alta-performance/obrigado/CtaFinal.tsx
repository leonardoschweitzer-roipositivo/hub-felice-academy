    ...
    <section className="sec obg-final">
      <div className="wrap">
        <div className="obg-final-card reveal">
          ...
          <p>
            Em uma conversa, eu te entrego um plano claro para a sua recepção encantar sem perder a
            eficiência — com a orientação de quem cobra esse padrão na própria clínica. Te espero lá.
          </p>
