    ...
    <footer className="felice-footer">
      <div className="wrap">
        ...
        <div className="foot-links">
          <a href="#ciclo">O ciclo da consultoria</a>
          <a href="#entregas">Entregáveis</a>
          <a href={APLICACAO_URL}>Candidatar-se</a>
          <a href="/privacidade">Política de Privacidade</a>
          <a href="/termos">Termos de Uso</a>
        </div>
        <p className="legal">
          <b>CNPJ: 25.307.550/0001-89.</b> Aviso legal: este serviço não garante a obtenção de
          ...
          substitui formação, julgamento e responsabilidade profissional. Não compartilhamos seu
          e-mail com ninguém e você pode cancelar sua inscrição a qualquer momento. Ao se cadastrar,
