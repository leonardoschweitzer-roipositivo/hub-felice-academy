/* Depoimentos (vídeo) + Garantia do Curso Gestão F4. */

import { DEPOIMENTOS } from './content';

export function GestaoF4Depoimentos() {
  return (
    <section className="sec">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Donos de clínica que saíram do improviso para{' '}
            <span className="gold-grad">o processo</span>
          </h2>
        </div>
...
export function GestaoF4Garantia() {
  return (
        ...
        <div className="guarantee reveal">
          <div className="seal">
            <svg className="seal-svg" viewBox="0 0 200 200" aria-hidden="true">
              <defs>
                <path id="seal-arc-gf4" d="M100,100 m-78,0 a78,78 0 1,1 156,0 a78,78 0 1,1 -156,0" />
              </defs>
              ...
              <g className="seal-rotor">
                <text className="seal-text">
                  <textPath href="#seal-arc-gf4" startOffset="0%">
          ...
          <div>
            ...
            <p>
              Assista às primeiras aulas com calma e comece a aplicar. Se o Curso Gestão F4 não for
              para você, peça o reembolso em até 7 dias — devolvemos 100% do valor, sem perguntas e
              sem burocracia. A decisão de continuar é totalmente sua.
            </p>
          </div>
        </div>
      </div>
