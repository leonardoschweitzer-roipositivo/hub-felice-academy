...
/* ============================================================
   CURSO GESTÃO F4 · Seções da landing (padrão Felice / dourado)
   Fork estrutural da Maestria — mesmas classes de felice.css / maestria.css.
   Copy e dados vêm de ./content.ts.
   ============================================================ */

/* ---------- Hero (2 colunas: headline + cards glass de prova) ---------- */
export function GestaoF4Hero() {
  return (
...
/* ---------- Números / prova ---------- */
export function GestaoF4Numeros() {
  return (
...
/* ---------- Problema / dores ---------- */
export function GestaoF4Problema() {
  return (
    <section className="sec problem">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            A sua clínica fatura — mas{' '}
            <span className="gold-grad">depende de você para tudo?</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Sem processo, a clínica vira uma extensão das suas costas: você no centro de cada decisão,
            apagando incêndio em vez de crescer.
          </p>
        </div>
        <div className="problem-photo reveal d1">
          <picture>
            ...
            <img
              ...
              alt="Dono de clínica sobrecarregado, preso na operação do dia a dia"
              width={1000}
              height={545}
              loading="lazy"
            />
...
/* ---------- Método / os 4 pilares ---------- */
export function GestaoF4Metodo() {
  return (
    <section className="sec" id="metodo">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Os <span className="gold-grad">4 pilares</span> que fazem a clínica rodar sem você
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Atendimento, Agendamento, Marketing e Gestão. Cada pilar vira processo — e a soma deles
            tira a clínica das suas costas.
          </p>
        </div>
...
/* ---------- Módulos ---------- */
export function GestaoF4Modulos() {
  return (
    <section className="sec" id="modulos">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            4 módulos. <span className="gold-grad">Um para cada pilar.</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Aulas práticas, organizadas para você implementar passo a passo — sem pular etapa.
          </p>
        </div>
      ...
      <div className="wrap">
        ...
        <div className="mz-bonus-total reveal">
          ...
          <p className="mz-bonus-total-note">
            Tudo isto está <b>incluso gratuitamente</b> na sua matrícula do Curso Gestão F4.
          </p>
        </div>
      </div>
    </section>
...
export function GestaoF4Plataforma() {
  return (
    <section className="sec">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Não é um vídeo solto. É <span className="gold-grad">um método organizado.</span>
          </h2>
        </div>
...
/* ---------- Autoridade / mentor ---------- */
export function GestaoF4Autoridade() {
  return (
...
/* ---------- Oferta ---------- */
export function GestaoF4Oferta() {
  return (
    <section className="sec offer" id="oferta">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Garanta seu acesso ao <span className="gold-grad">Curso Gestão F4</span>
          </h2>
        </div>
