/* ============================================================
   Página de Obrigado · Curso Gestão F4 — configuração central
...
export const QUESTIONARIO_URL = '/produtos/gestao-f4/consultoria';

/** Rota da página de confirmação (recebimento dos dados). */
export const CONFIRMACAO_URL = '/produtos/gestao-f4/consultoria/confirmado';
...
export const ORIGEM_LABEL = 'Curso Gestão F4 · consultoria gratuita (pós-compra)';

export const WHATSAPP_URL =
  `https://wa.me/${WHATSAPP_NUMERO}?text=` +
  encodeURIComponent(
    'Olá! Acabei de adquirir o Curso Gestão F4 e quero agendar minha consultoria gratuita.',
  );
...
/** Opcional: URL de um vídeo de boas-vindas (embed iframe). Vazio = esconde o slot.
    ...
    Trocar pelo vídeo de boas-vindas específico do Curso Gestão F4 quando houver. */
