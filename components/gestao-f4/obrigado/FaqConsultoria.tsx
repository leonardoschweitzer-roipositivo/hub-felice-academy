...
const PERGUNTAS: { q: string; a: string }[] = [
  {
    ...
    a: `É sim. Normalmente eu cobro R$ 500 por uma hora de consultoria, mas nesta semana liberei alguns horários gratuitos para quem acabou de adquirir o Curso Gestão F4. É a forma que encontrei de garantir que você realmente coloque o método em prática.`,
  },
  {
    q: 'Quanto tempo dura?',
    a: 'É uma hora comigo, focada na sua clínica: eu faço o diagnóstico, definimos as prioridades e montamos o seu plano de implementação dos 4 pilares.',
  },
  {
  ...
  },
  {
    ...
    a: 'Não precisa. Ajuda se você já tiver assistido às primeiras aulas, mas pode chegar só com as suas dúvidas e o cenário atual da clínica que a gente resolve juntos.',
  },
  {
    q: 'Posso participar com a minha equipe?',
    a: 'Pode, e eu até recomendo. Quem vai executar os 4 pilares no dia a dia aproveita muito a nossa conversa.',
  },
  {
