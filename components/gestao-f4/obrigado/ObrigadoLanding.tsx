...
/* ============================================================
   FELICE ACADEMY · CURSO GESTÃO F4 — página de OBRIGADO (pós-compra)

   Objetivo único: agendar a consultoria gratuita de 1h.
   Contexto: o comprador acabou de adquirir o CURSO dos 4 pilares de
   gestão — a consultoria é o atalho para sair das aulas e implementar
   o método na clínica. Toda configuração vive em ./config.ts.
   ============================================================ */
