...
/* ============================================================
   "A SECRETÁRIA QUE VENDE" · Seções da landing (padrão Felice / dourado)
   Fork estrutural do Gestão F4 / Maestria — mesmas classes de
   felice.css / maestria.css. Copy e dados vêm de ./content.ts.
   ============================================================ */

/* ---------- Hero (2 colunas: headline + cards glass de prova) ---------- */
export function SecretariaVendeHero() {
  return (
...
/* ---------- Números / prova ---------- */
export function SecretariaVendeNumeros() {
  return (
...
/* ---------- Problema / dores ---------- */
export function SecretariaVendeProblema() {
  return (
    <section className="sec problem">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            Sua recepção atende bem — mas{' '}
            <span className="gold-grad">está fechando tratamento?</span>
          </h2>
          <p className="lead" style={{ margin: '0 auto' }}>
            Você investe em marketing e traz paciente. Só que, sem técnica de venda na linha de
            frente, boa parte desse paciente vira orçamento parado e cadeira vazia.
          </p>
        </div>
...
export function SecretariaVendeMetodo() {
  return (
...
/* ---------- Módulos ---------- */
export function SecretariaVendeModulos() {
  return (
      ...
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <p className="lead" style={{ margin: '0 auto' }}>
            ...
            etapa e com script pronto em cada uma.
          </p>
        </div>
...
export function SecretariaVendePlataforma() {
  return (
    <section className="sec">
      <div className="wrap">
        <div className="sec-head center reveal">
...
/* ---------- Autoridade / mentor ---------- */
export function SecretariaVendeAutoridade() {
  return (
...
/* ---------- Oferta ---------- */
export function SecretariaVendeOferta() {
  return (
...
/* ---------- CTA final ---------- */
export function SecretariaVendeFinal() {
  return (
