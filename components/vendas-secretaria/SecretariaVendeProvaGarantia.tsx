...
export function SecretariaVendeDepoimentos() {
  return (
...
export function SecretariaVendeGarantia() {
  return (
        ...
        <div className="guarantee reveal">
          <div className="seal">
            <svg className="seal-svg" viewBox="0 0 200 200" aria-hidden="true">
              <defs>
                <path id="seal-arc-svend" d="M100,100 m-78,0 a78,78 0 1,1 156,0 a78,78 0 1,1 -156,0" />
              </defs>
              ...
              <g className="seal-rotor">
                <text className="seal-text">
                  <textPath href="#seal-arc-svend" startOffset="0%">
