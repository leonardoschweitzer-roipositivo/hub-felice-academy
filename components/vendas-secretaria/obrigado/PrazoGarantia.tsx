    ...
    <section className="sec obg-prazo-sec">
      <div className="wrap">
        <div className="obg-prazo reveal">
          ...
          <p>
            Como você acabou de matricular a sua equipe no CRC de Alta Performance, abri uma
            quantidade limitada de horários gratuitos na minha agenda esta semana para te ajudar a
            tirar o método do vídeo e pôr na sua recepção. Quando essas vagas acabarem, a consultoria
