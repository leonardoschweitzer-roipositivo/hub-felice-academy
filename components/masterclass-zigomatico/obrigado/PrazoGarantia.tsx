...
/* Escassez: uma hora comigo valeria R$ 500; nesta semana liberei alguns
   horários gratuitos para quem acabou de entrar na masterclass. */
    ...
    <section className="sec obg-prazo-sec">
      <div className="wrap">
        <div className="obg-prazo reveal">
          ...
          <p>
            Como você acabou de garantir seu acesso à Masterclass Zigomático Descomplicado, abri uma
            quantidade limitada de horários gratuitos na minha agenda esta semana para te ajudar a
            dar o próximo passo. Quando essas vagas acabarem, a consultoria volta a ser paga — então
            garanta a sua agora.
          </p>
