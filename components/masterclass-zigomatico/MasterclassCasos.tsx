...
export function MasterclassCasos() {
      ...
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <p className="lead" style={{ margin: '0 auto' }}>
            Uma seleção de casos reais de maxila atrófica abordados na masterclass — do diagnóstico à
            reabilitação.
          </p>
        </div>

        <div className="mz-casos reveal">
          <button type="button" className="mz-casos-nav mz-casos-prev" onClick={() => scroll(-1)} aria-label="Casos anteriores">
          ...
          <button type="button" className="mz-casos-nav mz-casos-next" onClick={() => scroll(1)} aria-label="Próximos casos">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
