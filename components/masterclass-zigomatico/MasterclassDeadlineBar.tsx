...
export function MasterclassDeadlineBar() {
    ...
    <div className="urgency-bar" ref={barRef}>
      <div className="wrap urgency-bar-inner">
        <div className="countdown" role="timer" aria-live="off">
          ...
          <span className="countdown-label">{HERO.countdownLabel}</span>
          <span className="countdown-clock mz-clock">
            <span className="mz-seg"><b>{pad(d)}</b><em>dias</em></span>
            <i>:</i>
            <span className="mz-seg"><b>{pad(h)}</b><em>hrs</em></span>
            <i>:</i>
            <span className="mz-seg"><b>{pad(m)}</b><em>min</em></span>
            <i>:</i>
