...
// As perguntas saíram daqui para `components/felice/faq.ts` (dados puros):
// o assistente do site monta a base de conhecimento no servidor e não pode
// importar de um módulo `'use client'`.
import { FAQ as PERGUNTAS } from '../faq';
