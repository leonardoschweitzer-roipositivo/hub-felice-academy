...
import { WHATSAPP_URL, DOCS_URL } from '../sections/obrigado/config';
    ...
    <header className="obg-hero cons-confirma">
      ...
      <div className="wrap obg-hero-inner">
        ...
        <div className="obg-cta-row reveal d3">
          <Link href={DOCS_URL} className="btn btn-primary btn-lg">
            Acessar meus documentos do Kit F4 <span className="arrow">→</span>
          </Link>
        </div>
      </div>
    </header>
