...
/* Questionário de qualificação do lead. Não pergunta faturamento —
   ...
   mix de tratamentos, maturidade e gestão) permitem inferir a
   capacidade de faturamento atual da clínica. */
      ...
      <div className="wrap cons-inner">
        ...
        <form className="cons-form" onSubmit={submit}>
          ...
          <div className="cons-submit">
            ...
            <a className="cons-skip" href={DOCS_URL}>
              Agora não — acessar meus documentos →
            </a>
          </div>
        </form>
      </div>
