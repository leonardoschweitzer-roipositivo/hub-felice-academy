...
import { CASOS, CASOS_HEAD } from './content';

/* Carrossel de casos reais — mesma estrutura da Masterclass/Maestria
   (.mz-casos / .mz-casos-track, definidos em maestria.css). */
export function MentoriaZigomaticoCasos() {
    ...
    <section className="sec" id="casos">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <h2>
            {CASOS_HEAD.titlePre} <span className="gold-grad">{CASOS_HEAD.titleGold}</span>
          </h2>
